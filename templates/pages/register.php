        ...
        <?php if (empty($registrationErr)): ?>
            ...
            <div class="field">
                ...
                <p class="help is-danger">
                    ...
                    password that is memorable is to select a few words, and
                    separate them using different symbols. Alternatively, use a password manager and generate a more secure one.
                </p>
                <?php endif; ?>
            </div>
